...
const UserDetail = () => {
  ...
  const hasUserimage = useCallback(() => {
    return username === 'ゲストユーザ' || (username !== 'ゲストユーザ' && userimage === '')
  }, [username, userimage])
        ...
        {userid && (
          <StyledPaper sx={{ width: '100%', mt: 2 }}>
            <Grid container spacing={2} direction="column" alignItems="center">
              ...
              <Grid item sx={{ mt: 2 }}>
                <PrimaryButton label={'ユーザ情報を編集'} onClick={() => navigate('/users/edit')} />
              </Grid>
              <Grid item>
                <PrimaryButton label={'退会する'} onClick={handleDeleteUser} color="error" />
              </Grid>
            </Grid>
          </StyledPaper>
        )}
