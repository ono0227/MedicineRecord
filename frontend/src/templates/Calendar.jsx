...
const Calendar = () => {
  ...
  useEffect(() => {
    ...
    if (selectedMedicineName && posts) {
      ...
      const filteredPostsByMedicine = posts.filter((post) => post.medicine?.name === selectedMedicineName)
      ...
      for (const date in groupedPostsByDate) {
        ...
        if (medicineInfo) {
          ...
          if (
            dailyPosts.length === medicineInfo.ingestion_times_per_day &&
            totalIngestionAmount === expectedTotalAmount
          ) {
  ...
  return (
    <div className="c-section-container">
      ...
      {selectedMedicineName &&
        ...
        posts.some((post) => post.medicine?.name === selectedMedicineName) && (
