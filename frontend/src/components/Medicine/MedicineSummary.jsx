        ...
        <Card className={classes.root}>
            {props.medicineImage && props.medicineImage.url ? (
                <CardMedia
                    ...
                    title=""
                    onClick={() => dispatch(push('/medicines/' + props.id))}
                />
            ) : (
                <div className={classes.media} onClick={() => dispatch(push('/medicines/' + props.id))}>
                    画像なし
                </div>
            )}
            <CardContent className={classes.content}>
                <div onClick={() => dispatch(push('/medicines/' + props.id))}>
